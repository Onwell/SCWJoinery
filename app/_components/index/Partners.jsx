				...
				<div className={`${styles.partners__content} relative`}>
					...
					<div className='relative'>
						<SectionTitle
							...
							dataTitle="Our Trusted Partners"
						/>
						We collaborate with some of the most renowned suppliers globally, ensuring we deliver the highest quality materials and craftsmanship. 
					</div>
				</div>
			</div>
		</div>
